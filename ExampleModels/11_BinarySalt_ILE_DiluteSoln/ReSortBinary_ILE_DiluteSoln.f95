...
contains
  ...
  subroutine write_to_screen(it)
    ...
    if (it.EQ.1) then       ! write the headers on the first entrance into write all voltage
      write(*, header_fmt) 'Time',  'Conc', 'Phi_1_1', 'Phi_1_NJ'
      write(*, header_fmt) 'hours', 'mol/L', 'Volts', 'Volts'
    end if
    ...
    write(*, data_fmt) t_write,    c0,  Phi_1_1, Phi_1_NJ, Phi_1_1 - Phi_1_NJ, &
    & i_rxn_1, i_rxn_NJ
...
!           write the headers on the first entrance into write all voltage
    ...
    do j = 1, NJ                                    !
      ...
      i_rxn = Butler_Volmer_Rxn(cprev(1,1),cprev(2,1))
                                                    !
      write(56, data_fmt) t_write,    xx(j),    c0, Phi_1, i_rxn!, Phi_2
