...
module user_input
  ...
  real               :: delT = 3.6e3                       ! size of timestep [s]
  real               :: time                             ! [s]
...
contains
  ...
  subroutine write_to_screen(it)
    ...
    if (it == 0) then       ! write the headers on the first entrance into write all voltage
      ...
      write(*, header_fmt) '###',   'Volts' , 'mol/L', 'Volts',   'Volts',    'Volts',  'mA/cm2' , 'mA/cm2'
      ...
      write(*, data_fmt) it, Delta_V, c0,  Phi_1_1, Phi_1_NJ, Phi_1_1 - Phi_1_NJ, i_rxn_1, i_rxn_NJ
...
!           write the headers on the first entrance into write all voltage
      ...
      do j = 1, NJ                                    !
        c0    = cprev(1,j) * 1e3                      !
        Phi_1 = cprev(2,j)
        i_rxn = Butler_Volmer_Rxn(cprev(1,1), cprev(2,1))
                                                      !
