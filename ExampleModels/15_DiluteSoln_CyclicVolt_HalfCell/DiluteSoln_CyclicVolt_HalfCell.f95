...
module write_data_mod
  ...
  real :: i_rxn, i_rxn_1, i_rxn_NJ, i_BV
...
contains
  ...
  subroutine write_to_screen(it)
    ...
    if (it == 0) then       ! write the headers on the first entrance into write all voltage
      write(*, header_fmt) 'Iters', 'DeltaV', 'Conc',  'Phi_1', 'Phi_2', 'DeltaV', 'i_rxn_1'
      write(*, header_fmt) '###',   'Volts' , 'mol/L', 'Volts', 'Volts',    'Volts',  'A/cm2'
      ...
      Phi_1_NJ = cprev(2,NJ)
      Phi_2    = cprev(3,1)
      i_rxn_1  = Butler_Volmer_Rxn(cprev(1,1), Phi_1_1, Phi_2)

      write(*, data_fmt) it, Delta_V, c0,  Phi_1_1, Phi_2, Phi_1_1 - Phi_1_NJ, i_rxn_1
...
!           write the headers on the first entrance into write all voltage
      write(56, header_fmt) 'Iters', 'DeltaV', 'Position', 'Conc',  'Phi_1', 'Phi_2', 'i_rxn', 'i_BV'
      write(56, header_fmt) '###',   'Volts'    , 'cm'   , 'mol/L', 'Volts', 'Volts', 'A/cm2', 'A/cm2'
                                                      !
    else                                              !
      ...
      do j = 1, NJ                                    !
        c0    = cprev(1,j) * 1e3                      !
                                                      !
        write(56, data_fmt) it, Delta_V, xx(j), c0, Phi_1, Phi_2, i_rxn, i_BV
...
program unsteady
  ...
  & Delta_V_upper_limit = 150e-3, Delta_V_lower_limit = -400e-3
