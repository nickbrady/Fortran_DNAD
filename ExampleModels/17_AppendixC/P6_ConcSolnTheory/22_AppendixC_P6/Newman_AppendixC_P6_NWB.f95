...
! ***** WRITE TO SCREEN **** !
    write(*, header_fmt) 'Iter', 'Position', 'C_O2', 'C_OH',  'C_Na',  'C_Cl',  'Phi',   'C_H2O', &
                       & 'Flux_H2O', 'Flux_OH', 'Flux_Cl', 'Flux_Na', 'Flux_O2'
    ...
    do j = 1, NJ                                    !
      ...
      Flux_O2  = c(5,j)
                                                    !
      write(*, data_fmt) iteration, h*dble(j-1), c_O2, c_OH, c_Na, c_Cl, Phi, c_H2O, Flux_H2O, &
...
! ***** WRITE TO FILE ****** !
    ...
    do j = 1, NJ
      ...
      Flux_O2  = c(5,j)
                                                    !
      write(56, data_fmt) iteration, h*dble(j-1), c_O2, c_OH, c_Na, c_Cl, Phi, c_H2O, Flux_H2O, &
                    & Flux_OH, Flux_Cl, Flux_Na, Flux_O2
    end do
