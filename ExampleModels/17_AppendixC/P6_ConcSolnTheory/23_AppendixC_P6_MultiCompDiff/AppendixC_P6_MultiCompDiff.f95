  ...
  subroutine write_to_screen(it)
    ...
    do j = 1, NJ                                    !
      ...
      Phi     = cprev(11,j) * Rigc*Temp/Fconst
                                                    !
      write(*, data_fmt) xx(j), c_O2, c_OH, c_Na, c_Cl, Phi, c_H2O
    end do
...
!           write the headers on the first entrance into write all voltage
    ...
    do j = 1, NJ
      ...
      Phi     = cprev(11,j) * Rigc*Temp/Fconst
                                                    !
      write(56, data_fmt) xx(j), c_O2, c_OH, c_Na, c_Cl, Phi, c_H2O
    end do
...
subroutine initial_condition()
  ...
  cprev(10,:)   = cbulk_O2 / c_total_bulk
  cprev(6,:)    = 1.0
  do i = 7, 10
