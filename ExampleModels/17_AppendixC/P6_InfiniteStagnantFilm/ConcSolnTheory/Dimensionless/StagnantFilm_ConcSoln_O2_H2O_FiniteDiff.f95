...
module user_input
  ...
  integer, parameter :: NJ = 501                          ! Number of mesh points
  integer, parameter :: Numbertimesteps = 30 * 3.6e3     ! Number of time steps
  integer, parameter :: maxIterations = 100!1e6
  ...
  real, parameter :: xbulk_H2O = 1.0 - xbulk_O2
...
!           write the headers on the first entrance into write all voltage
      write(56, header_fmt) 'Time',  'Position', 'x_O2', 'x_H2O', 'Flux_O2', 'Flux_H2O'
...
! i.e c0 = c_vars_dual(1), dPhi2_dx = dcdx_vars_dual(2)
  ...
  function GOV_RHS(c_vars_dual, dcdx_vars_dual, d2cdx2_vars_dual, position)  result(GOV_)
    ...
    GOV_(2)    = 2*position*dcdx_H2O - dNdx_H2O
    GOV_(3)    = x_O2 + x_H2O - 1.0
    GOV_(4)    = dcdx_O2 - (x_O2 * N_H2O - x_H2O * N_O2)
...
! dc_n%x = 0.0      -->   dc        -->           BC_WEST_(2) = dc_n/delT - rxn
  function Boundary_WEST (c_vars_dual, dcdx_vars_dual, position) result(BC_WEST_)
    ...
    BC_WEST_(1) = x_O2 - 0.0
    BC_WEST_(2) = N_H2O - 0.0
    BC_WEST_(3) = x_O2 + x_H2O - 1.0
    BC_WEST_(4) = dcdx_O2 - (x_O2 * N_H2O - x_H2O * N_O2)
  ...
  function Boundary_EAST (c_vars_dual, dcdx_vars_dual, position) result(BC_EAST_)
    ...
    BC_EAST_(2) = 2*position*dcdx_H2O - dNdx_H2O
    BC_EAST_(3) = x_O2 + x_H2O - 1.0
    BC_EAST_(4) = x_O2 - xbulk_O2
