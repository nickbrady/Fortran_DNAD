...
module user_input
  ...
  integer, parameter :: Numbertimesteps = 25 * 3.6e3       ! Number of time steps
...
contains
  ...
  subroutine write_to_screen(it)
    ...
    if (it == 0) then       ! write the headers on the first entrance into write all voltage
      ...
      write(*, data_fmt) t_write, conc_Li-cbulk_Li
...
subroutine initial_condition()
  ...
  ! do j = 1, NJ
    cprev(1,:) = xx/xmax * cbulk_Li * 2 * _percent_max_ + (cbulk_Li * (1 - _percent_max_))
  ! end do
