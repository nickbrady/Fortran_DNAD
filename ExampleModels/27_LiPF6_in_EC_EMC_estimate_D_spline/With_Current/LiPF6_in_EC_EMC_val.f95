...
contains
  ...
  function diffusion_coef_LiPF6_in_EC_EMC_dual(c_LiPF6)    result(D_salt)
    ...
    if (c <= 1.5) then
	 D_salt =  -3.76459087669e-22*(c-0.0)**3 + 6.60768175583e-07*(c-0.0)**2  -3.69156378601e-06*(c-0.0) + 6.04074074074e-06
else 
	 D_salt =  0.0*(c-1.5)**3 + 6.60768175583e-07*(c-1.5)**2  -1.70925925926e-06*(c-1.5) + 1.99012345679e-06
end if
