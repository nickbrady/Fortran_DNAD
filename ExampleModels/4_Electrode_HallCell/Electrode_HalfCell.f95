...
! ******************************************************************************
  ...
  if (trim(geometry) == 'Rectangular') then
    applied_current_A = applied_specific_current/1000 * (1 - agg_porosity) * density_Fe3O4 * xmax

  else if (trim(geometry) == 'Cylindrical') then
    applied_current_A = applied_specific_current/1000 * (1 - agg_porosity) * density_Fe3O4 * xmax/2.0
