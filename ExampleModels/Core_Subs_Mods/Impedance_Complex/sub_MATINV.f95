...
! edits: June 3, 2022
! because BTRY, BNEXT, and BMAX are essentially values of the magnitude of the matrix
! entries, these can and should remain as real numbers
! ABS(z) --> |z|, where z is a complex number

! real --> complex: F, DETERM

!   elemental subroutine swap(a, b)
     ! row exchange: switch row A and row B
!     real, intent(in out) :: a, b       --> complex, intent(in out) :: a, b
!     real :: save_val                   --> complex :: save_val
...
contains
  ! this could be overloaded to have a swap_real and swap_complex
  elemental subroutine swap(a, b)
     ! row exchange: switch row A and row B
