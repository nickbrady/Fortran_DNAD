...
module dnadmod
    ...
    ! use number_of_variables, only: N
    ! use user_input, only: N
    implicit none
    integer, PARAMETER :: N = 1
    integer, PARAMETER :: ndv = N*1   ! cprev_vars and dcdx_vars
...
!
!     complex             :: z
!     type(dual_complex)  :: dz, dz1
!
!     z = complex(3, 4)
!
!     print*,
!
!     dz = dual_complex(z, complex(1., 0.))
!     dz1 = dual_complex(complex(0.5, 0), complex(1., 0.))
!
!     print*, 'dz'
!     print*, dz
!     print*, acosh(dz)
